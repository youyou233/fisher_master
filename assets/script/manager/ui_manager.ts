...
import SercretInfoUIManager from "../UI/sercret_info_ui_manager"
...
export default class UIManager extends cc.Component {
    ...
    showSercretInfoUI(data) {
        if (SercretInfoUIManager.instance) {
            SercretInfoUIManager.instance.showUI(data)
        } else {
            this.loadUIRes("ui/shop_ui", UIManager.Z_ORDER_5, function() {
                SercretInfoUIManager.instance.showUI(data)
            })
